...
class AbsenGurustaffListDataContainer extends Component {
  constructor(props) {
    super(props);
  ...
  componentWillMount() {
    ...
    this.props.fetchAll(this.props.SettingReducer.neDBDataPath, 'absenGurustaff');
  ...
  render() {
    return (
      <ListData
        ...
        filterTextInput='filterTextInputAbsenGurustaff'
...
function mapStateToProps(state) {
  ...
  // });
  return {
    listData: state.AbsenReducer.listDataGurustaff,
